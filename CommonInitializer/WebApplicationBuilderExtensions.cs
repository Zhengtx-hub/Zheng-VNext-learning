    ...
    public static class WebApplicationBuilderExtensions
    {
        ...
        public static void ConfigureExtraServices(this WebApplicationBuilder builder, InitializerOptions initOptions)
        {
            ...
            services.AddAllDbContexts(ctx =>
            {
                ...
                string ? connStr = configuration.GetConnectionString("DefaultDB:ConnStr");
            ...
            // Console.WriteLine(rabbitMQSection["UserName"]);
            // Console.WriteLine(rabbitMQSection["Password"]);
            // Console.WriteLine(rabbitMQSection["ExchangeName"]);
